...
log "6/19 Claude Code Subtopics..."
...
log "7/19 Claude Code New Subtopics..."
...
log "9/19 Make Money Matt channel..."
...
log "10/19 Miss Luna Vega playlist..."
...
log "11/19 Finance Money Coach channel..."
...
log "12/19 Finance Money Buffalo channel..."
...
log "13/19 Finance A-Academy channel..."
...
log "14/19 Finance Financial Diet channel..."
...
log "15/19 Finance Humphrey Yang channel..."
...
log "16/19 Boom BigNose channel..."
...
log "17/19 Health — อาหารบำรุงสุขภาพ topic..."
bash "$_DIR/run_ai_trends_with_creds.sh" --topic "อาหารบำรุงสุขภาพ" --report-folder "health/health_food_nutrition" --max-results 5 --detailed >> "$LOGS/health_food_nutrition.log" 2>&1 && log "  ✅ Done" || log "  ❌ Failed"

log "18/19 Health — Top to Toe playlist..."
bash "$_DIR/run_ai_trends_with_creds.sh" --topic "Top to Toe" --report-folder "health/top_to_toe" --channel "https://youtube.com/playlist?list=PLUaBTRNM7hIVi9p5t8-NtYgGN8zmi0X8N" --max-results 5 --detailed >> "$LOGS/health_top_to_toe.log" 2>&1 && log "  ✅ Done" || log "  ❌ Failed"

log "19/19 Daily Summary + GitHub Upload..."
